    ...
    <>
      ...
      >
        <section className="text-white overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-row items-center relative z-10">
            <div className="w-1/2 pr-4 md:pl-32">
              <h1 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 leading-tight animate-fade-in-up">
                Selamat datang di Rentalin
              </h1>
              <p className="text-base sm:text-lg mb-6 sm:mb-8 opacity-90 animate-fade-in-up animation-delay-200">
                Aplikasi yang membuat perjalanan lebih nyaman, siap membantu
                mobilitas kapan saja dan di mana saja.
              </p>
              <div className="animate-fade-in-up animation-delay-400">
                <button className="bg-white text-black px-4 sm:px-8 py-2 sm:py-4 rounded-full text-sm sm:text-lg font-semibold hover:bg-opacity-90 transition duration-300 flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
            ...
            <div className="w-1/2 relative md:pr-32">
              <Image
            ...
            <div className="lg:pr-24 flex items-center">
              <div className="data w-full">
                ...
                <p className="font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                  ...
                  we&apos;re redefining urban transportation, one ride at a time.
                </p>
              </div>
            </div>
            <div className="img-box animate-fade-in-up">
              <img
                src="images/dummy_images.jpg"
                alt="About Us"
      ...
      <section id="features" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div className="text-center bg-gray-100 p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
              ...
              <p className="text-gray-600">
                Pilih dari berbagai jenis motor untuk setiap kesempatan.
              </p>
            </div>
            <div className="text-center bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300">
              ...
              <p className="text-gray-600">
                Ambil dan kembalikan di berbagai lokasi di seluruh Indonesia.
              </p>
            </div>
            <div className="text-center bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300">
              <svg
              ...
              <p className="text-gray-600">
                Pengguna terverifikasi dan opsi pembayaran yang aman.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="lg:mb-0 mb-10">
              <div className="group w-full h-full">
                <div className="relative h-full">
                  ...
                  <div className="absolute bottom-0 w-full lg:p-11 p-5 transform -translate-y-3/4">
